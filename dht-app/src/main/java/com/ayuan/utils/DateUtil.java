...
public class DateUtil {
    ...
    public static Date getDateByString(String dateStr, String format) {
        ...
        try {
            ...
            switch (format) {
                case DEFAULT_PATTERN_DATE:  //"yyyy-MM-dd"
    ...
    public static boolean sendSms() {
        Date nowDate = new Date();
        // "yyyy-MM-dd"
        String sf = DateUtil.getStringDate(nowDate);
        // "yyyy-MM-dd HH:mm:ss"
        Date tS = DateUtil.getDateTimeByString(sf + " 09:00:00");
        Date tE = DateUtil.getDateTimeByString(sf + " 18:00:00");
        if (nowDate.getTime() >= tS.getTime() && nowDate.getTime() <= tE.getTime()) {
            return true;
        }
        return false;
    }
    ...
    public static int differentHours(Date date1, Date date2) {
        ...
        long betweenHours = (time2 - time1) / (1000 * 60 * 60);
...
//        List<Date> list = new ArrayList<>();
//        list.add(DateUtil.getDateTimeByString("2020-08-25 13:20:30"));
//        list.add(DateUtil.getDateTimeByString("2020-08-25 19:20:30"));
//        list.add(DateUtil.getDateTimeByString("2020-08-26 13:32:30"));
//        list.add(DateUtil.getDateTimeByString("2020-08-26 18:32:30"));
//        list.add(DateUtil.getDateTimeByString("2020-07-26 13:20:30"));
//        list.add(DateUtil.getDateTimeByString("2019-08-25 13:20:30"));
//        list.add(DateUtil.getDateTimeByString("2020-08-22 13:20:30"));
//        list.forEach(it ->{
//            System.out.println(DateUtil.discussShowDate(it));
//        });
//        System.out.println(DateUtil.getHourByDate(new Date()));
//        for (int i = 0; i < 31; i++) {
...
//        }
//        System.out.println(DateUtil.sendSms());

        //System.out.println(DateUtil.getStringDateYYYYMMdd(new Date()));
        Date startTime = DateUtil.getDateByString("2021-06-29", DateUtil.DEFAULT_PATTERN_DATE);
        Date endTime = DateUtil.getDateByString("2021-07-15", DateUtil.DEFAULT_PATTERN_DATE);
        List<Date> betweenDate = getBetweenDate(startTime, endTime);
        betweenDate.forEach(it ->{
            System.out.println(DateUtil.getStringDate(it));
        });
